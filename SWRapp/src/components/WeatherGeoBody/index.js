...
const UseOpenWeatherAppKey = process.env.REACT_APP_OPEN_WEATHER_MAP_ID;
...
function Geoloc(props) {
  ...
  const { data, error } = useSWR(
    `https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?lat=${x}&lon=${y}&appid=${UseOpenWeatherAppKey}`,
